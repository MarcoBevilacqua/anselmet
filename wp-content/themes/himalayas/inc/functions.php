...
function himalayas_footer_copyright() {
   ...
   //sprintf( __( 'Theme: %1$s by %2$s.', 'himalayas' ), 'Himalayas', $tg_link ).' '.sprintf( __(          'Powered by %s.', 'himalayas' ), $wp_link ) . '</span>'

   $header = "<h3>Maison Anselmet</h3>";

   $default_footer_value = $address_link . $concept_link;

   $himalayas_footer_copyright = $header.'<div class="copyright">'.$default_footer_value. '</div>';
...
add_action( 'himalayas_footer_center', 'himalayas_footer_center', 10 );
/**
 * Function to show the footer info, copyright information
 */
if ( ! function_exists( 'himalayas_footer_center' ) ) :
   function himalayas_footer_center() {
      $header_fb = "<h3>Facebook
        <a href='https://www.facebook.com/maisonanselmet' target='_blank' title='pagina ufficiale'>
        <i class='fa fa-facebook-official'></i></a></h3>
        ";
      $header_fl = "<h3>FlickR <a href='https://www.flickr.com/photos/maisonanselmet' target='_blank' title='pagina ufficiale'>
        <i class='fa fa-flickr'></i></a></h3>";
      $fb_link = "https://www.facebook.com";
      $lb_link = "https://www.flickr.com";
      $uc = '<div class="copyright" style="text-align:center;">' .
          '<span class="copyright">Pagina in costruzione
         </span></div>';
      $fb_label = $header_fb . '<br />' . $header_fl ;
...
add_action( 'himalayas_footer_right', 'himalayas_footer_right', 10 );

/**
 * Function to show the footer info, copyright information
 */
if ( ! function_exists( 'himalayas_footer_right' ) ) :
   function himalayas_footer_right() {
      $febe_link = "http://www.contattofebe.it";
      $header_tw = "<h3>Twitter <a href='https://twitter.com/MaisonAnselmet' target='_blank' title='pagina ufficiale'>
        <i class='fa fa-twitter'></i></a></h3>";
      $header_pi = "<h3>Pinterest <a href='https://it.pinterest.com/maisonanselmet' target='_blank' title='pagina ufficiale'>
        <i class='fa fa-pinterest'></i></a></h3>";
      $concept = '<div class="copyright"><span class="copyright">Concept:
            <a href="'. $febe_link.'">Contatto Febe</a>
         </span></div>';

      $uc = '<div class="copyright" style="text-align:left;">' .
          '<span class="copyright">In costruzione</span></div>';
      $fb_label = $header_tw . '<br />' . $header_pi . '<br />' . $concept;
